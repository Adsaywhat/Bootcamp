...
function buyLunches() {
   ...
   if (money >= totalPrice) {
    ...
    document.getElementById("receipt").innerHTML += "<p>Today, sandwiches are: $" + priceToday + ". You dont have enough money. Maybe your sister will give you some of her sandwich.</p>";
    money = 0;
   }
}
